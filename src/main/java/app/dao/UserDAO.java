...
public interface UserDAO extends JpaRepository<User, java.lang.String> {
  ...
  public Page<User> findUsersByEstabelecimentoDeSaude(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<User> findUsersByConvenio(@Param(value="id") java.lang.String id, Pageable pageable);
