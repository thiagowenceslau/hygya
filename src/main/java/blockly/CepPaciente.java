...
public class CepPaciente {
	 ...
	 */
	// BuscarCep
	public static Var buscarCepPaciente() throws Exception {
		return new Callable<Var>() {
			...
			public Var call() throws Exception {
				url = Var.valueOf(Var.valueOf("https://viacep.com.br/ws/").toString()
						+ cronapi.screen.Operations.getValueOfField(Var.valueOf("Paciente.active.cep")).toString()
