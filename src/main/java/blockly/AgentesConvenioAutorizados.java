...
@CronappSecurity
public class AgentesConvenioAutorizados {
	...
	public static Var retornarConvenioLogado() throws Exception {
		return new Callable<Var>() {
			...
			public Var call() throws Exception {
				...
				convenioId = cronapi.database.Operations.getField(consulta, Var.valueOf("this[0].convenio.id"));
				return convenioId;
			}
		}.call();
	}
