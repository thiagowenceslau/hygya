...
public class SecurityPermission implements Permission {
    ...
    public static final String CONVENIO_ADMIN = "Convenio Administrativo";

  public static final String CONVENIO_OPERADOR = "Convenio Operador";

  public static final String ESTABELECIMENTO_ADMIN = "Estabelecimento Administrativo";

  public static final String ESTABELECIMENTO_OPERADOR = "Estabelecimento Operador";
