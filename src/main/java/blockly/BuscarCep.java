...
public class BuscarCep {
	 ...
	 */
	// BuscarCep
	public static Var buscarCepConvenio() throws Exception {
		return new Callable<Var>() {
			...
			public Var call() throws Exception {
				url = Var.valueOf(Var.valueOf("https://viacep.com.br/ws/").toString()
						+ cronapi.screen.Operations.getValueOfField(Var.valueOf("Convenio.active.cep")).toString()
